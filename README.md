...
return <div></div>
```
   ## 79.  Какой компонент нельзя  реализовать на хуках ErrorBoundary (предохранители)   
 ...
 ``` 
   ## 81.  Написать  filter через  reduce.   
  ```javascript
